...
export const increments = () => integer().autoincrement().primary();
...
export const updatedAt = () => timestamp().default('CURRENT_TIMESTAMP').onUpdate('CURRENT_TIMESTAMP')

// export const relation = (table: string, column: string) => new Relation(table, column);
// export const reference = (table: string, foreignKey: string) => new Relation(table, foreignKey);